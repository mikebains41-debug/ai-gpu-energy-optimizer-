      ...
      <div className="h-[400px]">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={data}>
            ...
            <Legend />
            <Area type="monotone" dataKey="totalPower" name="Total Power" stroke="#3b82f6" fillOpacity={1} fill="url(#colorTotal)" />
            <Area type="monotone" dataKey="renewablePower" name="Renewable Power" stroke="#10b981" fillOpacity={1} fill="url(#colorRenewable)" />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
