...
TESTS = [
    ...
    ("M22", "M22_alert_latency.py",      "Alert Latency"),
    ("M23", "M23_api_key_auth.py",       "API Key Auth"),
    ("M24", "M24_rate_limiting.py",      "Rate Limiting"),
    ("M25", "M25_node_isolation.py",     "Node Isolation"),
    ("M26", "M26_prometheus.py",         "Prometheus Scrape"),
    ("M27", "M27_grafana.py",            "Grafana Dashboard"),
    ("M28", "M28_kubernetes.py",         "Kubernetes DaemonSet"),
    ("M29", "M29_helm_install.py",       "Helm Install"),
    ("M30", "M30_end_to_end.py",         "End to End"),
]
...
def run_test(test_id, filename, name):
    ...
    return {"test_id": test_id, "name": name, "status": status, "duration_seconds": duration, "output": output[-1000:]}
...
def main():
    ...
    report = {"timestamp": timestamp, "total": 30, "passed": passed, "failed": failed, "gpu": "NVIDIA A100 SXM x2", "author": "Manmohan Bains", "results": results}
