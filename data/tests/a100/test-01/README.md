...
To establish the baseline power draw and utilization behavior of an idle A100 GPU over a continuous 10-minute period with no active workload. This provides a reference point for all subsequent tests.
...
A: nvidia-smi showed no active processes. Utilization was 0% for 10 minutes. No workload was submitted during this test.
