...
This test validates if the same lag occurs during burst workloads (100ms compute, 500ms idle).
...
| Metric | Value |
|--------|-------|
| Start Time | 2026/05/08 04:49:25.251 |
| End Time | 2026/05/08 04:54:29.764 |
| Total Samples | 3044 |
...
1. A100 shows NO ghost power during burst workloads
2. Power spikes to 406W with 100% utilization during 100ms bursts
3. Telemetry responds correctly to 100ms bursts
4. No observable telemetry lag during burst patterns
...
However, A100 Test 4 showed severe lag at 75% sustained load (343W power, 2% utilization). 
The issue is NOT with bursts but with specific sustained load levels where NVML sampling desynchronizes.

================================================================================
FREQUENTLY ASKED QUESTIONS:

Q: Does A100 have ghost power during bursts?
A: No. This test shows clean telemetry during 100ms bursts.

Q: Then where does ghost power come from?
A: A100 Test 4 showed ghost power at 10-50% sustained loads and severe lag at 75% load.

Q: Is A100 telemetry reliable for burst workloads?
A: Yes. This test shows accurate telemetry for 100ms bursts.

Q: How does this compare to H100?
A: Both GPUs show clean telemetry during bursts. H100 has higher power (71W idle, 412W burst).
...
- 3044 samples at ~100ms sampling = 304 seconds
- Start: 04:49:25.251
- End: 04:54:29.764
- Duration: 5 minutes 4 seconds ✅
...
A100 shows NO ghost power during burst workloads. Power spikes to 406W with 100% utilization during 100ms bursts. The observability issues identified in Test 4 (ghost power at low sustained loads, severe lag at 75% load) do not appear during burst patterns.
